        ...
        <div className="results">
          <div className="card" onClick={() => alert("card1")}>
						<div
							...
							style={{ backgroundImage: "url(https://tribwxmi.files.wordpress.com/2013/05/mustache-web.jpeg)"}} alt="" className="img-wrapper" />
          ...
          <div className="card" onClick={() => alert("card2")}>
						<div
							className="img-wrapper"
							style={{ backgroundImage: "url(http://www.backpaco.com/wp-content/uploads/2015/04/yosemite-waterfall.jpg)"}} alt="" className="img-wrapper" />
            <div className="card-content">
              <h1>CAMPING</h1>
          ...
          <div className="card" onClick={() => alert("card3")}>
						<div
							className="img-wrapper"
							style={{ backgroundImage: "url(http://travel.home.sndimg.com/content/dam/images/travel/fullset/2014/05/08/fc/top-10-hawaiian-beaches-lanikai-beach.rend.hgtvcom.1280.720.suffix/1491584246278.jpeg)"}} className="img-wrapper"/>
            <div className="card-content">
              <h1>HAWAII TRIP</h1>
              <h1>by. John Doe</h1>
							<div className="meter">
